...
new mdb.Chart(
  document.getElementById("chart-visibility"),
  dataVisibility,
  optionsMixedCharts
);
...
new mdb.Chart(
  document.getElementById("chart-acquisition"),
  dataAcquisition,
  optionsMixedCharts
);
...
new mdb.Datatable(document.getElementById("datatable"), basicData, { striped: true, borderless: true, hover: true });